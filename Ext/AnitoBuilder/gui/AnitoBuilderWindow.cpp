...
void gbe::editor::AnitoBuilderWindow::DrawSelf()
{
	...
	if (DrawIconSwitch("Select Mode ", &gbe::ext::AnitoBuilder::AnitoBuilderExtension::unit_select, TextureLoader::GetAssetRuntimeData("face select"), TextureLoader::GetAssetRuntimeData("floor select"), 30, 100, 1)) {
