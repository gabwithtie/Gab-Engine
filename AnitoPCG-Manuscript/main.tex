...
$ insert algorithm for mesh choice

$ insert example figure for algorithm for mesh choice
...
\newcommand{\meanCohere}{4.15}
\newcommand{\meanVar}{3.55}
\newcommand{\meanAppeal}{4.20}
