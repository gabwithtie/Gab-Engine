#include "AnitoBuilder.h"

gbe::ext::AnitoBuilder::AnitoBuilder::AnitoBuilder()
{
}
...
gbe::ext::AnitoBuilder::GenerationResult gbe::ext::AnitoBuilder::AnitoBuilder::Generate(GenerationParams params)
{
